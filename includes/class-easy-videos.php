...
class Easy_Videos {
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Easy_Videos_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Easy_Videos_Public( $this->get_plugin_name(), $this->get_version() );
